...
import { FdData } from './GovtPoFdData'
const GovtPoFdRates = () => {
  ...
  return (
    <div>
      <CCard>
        <CCardHeader>
          <h3 className="d-flex justify-content-center">Govt Bank & Post Office FD Rates</h3>
        ...
        <CCardBody>
          ...
          >
            <CTableHead>
              <CTableRow>
                <CTableHeaderCell scope="col">Name Of The Bank</CTableHeaderCell>
